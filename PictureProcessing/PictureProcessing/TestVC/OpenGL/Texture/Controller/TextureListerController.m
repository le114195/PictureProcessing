...
@interface TextureListerController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation TextureListerController
...
{
    TextureBaseController *openglVC = [TextureBaseController openglesVCWithIndex:indexPath.row];
