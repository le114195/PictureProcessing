...
@interface CurveListController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation CurveListController
...
{
    CurveBaseController *openglVC = [CurveBaseController openglesVCWithIndex:indexPath.row];
